...
welcome_handler = MessageHandler(
    Filters.status_update.new_chat_members, welcome, pass_job_queue=True
)
verification_handler = CallbackQueryHandler(
    verify_user, pattern=r"not_bot", pass_job_queue=True
)
